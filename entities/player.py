...
class Player(Creature):
    ...
    def trigger_keybind_ability(self, key):
        ...
        if key == 'q':  # Dash - short positional adjustment toward mouse
            self.ability_cooldowns['q'] = self.ability_durations['q']
            angle = self.body.angle
            # Short burst force — moves a small distance, not across the map
            dash_force = 1200 * self.body.mass
            ...
            self.dash_glide_timer = 0.15  # Short glide for 0.15 seconds
            return 'dash'
