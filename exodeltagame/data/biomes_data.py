BIOMES = {
    "membrane": {
        ...
        "boss": "membrane_boss",
        "level_range": (1, 3),
        "visual_theme": "organic_tissue",  # Pulsing veins, fleshy textures
    ...
    "vein": {
        ...
        "boss": "vein_boss",
        "level_range": (3, 6),
        "visual_theme": "flowing_liquid",  # Flowing streams, bubbles
    ...
    "cortex": {
        ...
        "boss": "cortex_boss",
        "level_range": (6, 9),
        "visual_theme": "crystalline",  # Geometric crystals, electric arcs
    ...
    "void_stomach": {
        ...
        "boss": "void_boss",
        "level_range": (9, 12),
        "visual_theme": "acidic",  # Dripping acid, dissolving surfaces
    ...
    "titan_core": {
        ...
        "boss": "xenarch",
        "level_range": (12, 15),
        "visual_theme": "inferno",  # Pulsing heat, fire-like effects
